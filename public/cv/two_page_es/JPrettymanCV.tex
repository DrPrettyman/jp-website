...
\begin{innerlist}
	\item Presenté resultados en reuniones con stakeholders en NPL, en artículos publicados y en conferencias internacionales.
	...
	\item Acceso, limpieza, interpolación e interpretación correcta de grandes conjuntos de datos meteorológicos crudos.
\end{innerlist}
...
\edusubsection{MA Matemáticas}{University of Edinburgh}{Matrícula de Honor de Primera Clase}
