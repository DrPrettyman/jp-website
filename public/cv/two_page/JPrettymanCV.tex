...
\begin{innerlist}
	...
	\item Regular use (10+ years) of Python libraries: ScikitLearn, Numpy, Pandas, NLTK, Matplotlib, Plotly.
	\item Full stack development with Bash, Python, Google Cloud Platform, SQL and JavaScript.
	\item Huggingface transformers and LLMs, Ollama, OpenAI Assistant API.
	\item Familiar with Git, GitHub, package management, ETL \& ELT, CI/CD, async, REST, GraphQL
	\item Experience with C++, MATLAB, Retool, data engineering, dashboards, scientific computing. 
\end{innerlist}
...
\begin{innerlist}
	\item Developed NLP-powered keyword clustering, combined with quantitative data, reducing manual work from days to minutes.
	...
	\item Worked with the team to replicate and then improve their (spreadsheet-based) processes with continual feedback and deployment.
...
\begin{innerlist}
	...
	\item Worked as part of a team and participated in daily stand-ups.
\end{innerlist} 
