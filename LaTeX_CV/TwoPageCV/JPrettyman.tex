...
\vspace{-6pt}
\begin{innerlist}
	% \item Deployment to remote UNIX serever using Docker and GitHub.
...
\textbf{Ph.D. Mathematics} — \includegraphics[height=0.8em]{images/Reading_shield.png} \textbf{University of Reading}\\
\vspace{-2pt}
...
\begin{innerlist}
	...
	\item In many cases I implemented mathematically derived methods —both my own 
		and those of others— numerically by discetising and linearising. 
...
\textbf{M.Res. Mathematics} — \includegraphics[height=0.8em]{images/ICL_shield.pdf} \textbf{Imperial College London} (\emph{Distinction})\\
\vspace{-2pt}
...
\textbf{MA Mathematics} — \includegraphics[height=0.8em]{images/Edinburgh_shield.jpg} \textbf{University of Edinburgh} (\emph{First Class Hons.}) \\
\vspace{-2pt}
